...
public:
    ...
    XRESULT RenderDepthOfField(ID3D11ShaderResourceView* backbuffer, ID3D11ShaderResourceView* waterMaskSRV, ID3D11ShaderResourceView* specularSRV, ID3D11RenderTargetView* reactiveMaskRTV = nullptr);
