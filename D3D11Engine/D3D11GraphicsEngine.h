...
public:
    ...
    bool BindTextureNRFX( zCTexture* tex, bool bindShader, bool updateMaterialInfo = true, float materialClassMarker = 0.0f );
...
private:
    ...
    bool GetVegetationCardCullDraw( MeshInfo* mesh, bool shadowIndices,
