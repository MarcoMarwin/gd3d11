...
float4 PSMain(PS_INPUT input) : SV_TARGET
{
    ...
    float activeRainExposureWeight = smoothstep(0.0f, 0.01f, saturate(WG_RainFXWeight));
    float puddleExposure = lerp(1.0f, puddleRainExposure, activeRainExposureWeight);
